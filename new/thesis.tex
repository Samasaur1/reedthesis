...
% - `tocchapterdots' - enable the Table of Contents dots between chapters.
% - `tocchaptername' - show "Chapter N" instead of just "N" in each ToC entry.
\documentclass[12pt,twoside, tocchapterdots, tocchaptername]{reedthesis}
