...
% - `bibstyle` - choose the bibliography style in use. defaults to numeric. Valid options are chicago-a, chicago-b, and all other biblatex options: https://www.overleaf.com/learn/latex/Biblatex_bibliography_styles
...
\section{Bibliographies}
	Of course you will need to cite things, and you will probably accumulate an armful of sources. This is why BibLaTeX was created. For more information about BibLaTeX and bibliographies, see our CUS site (\url{web.reed.edu/cis/help/latex/index.html})\autocite{reedweb:2007}. There are two pages on this topic: {\it biblatex} (which talks about using BibLaTeX, at \url{/latex/biblatex.html}) and {\it bibman} (which covers how to make and maintain a bibliography by hand, without BibLaTeX, at at \url{/latex/bibman.html}). The last page will not be useful unless you have only a few sources.

	We also provide convenient utilities to edit this in our template directly with the \texttt{bibstyle} option at the top of your file. This template has it set to \texttt{ieee} by default. We have special support for \texttt{chicago} and \texttt{apa}. All other styles can be found on Overleaf's BibLatex documentation: \url{https://www.overleaf.com/learn/latex/Biblatex_bibliography_styles}.
...
\item You can add a Reed Thesis citation\autocite{noble:2002} option. The best way to do this is to use the phdthesis type of citation, and use the optional ``type'' field to enter ``Reed thesis'' or ``Undergraduate thesis''. Here's a test of Chicago-b, showing the second cite in a row\autocite[Page 1]{noble:2002} being different, where chicago-b uses the ``Page 1'' postnote instead of giving the full citation Also the second time not in a row\autocite{reedweb:2007} should be different. Of course in other styles they'll all look the same.
\end{enumerate}
